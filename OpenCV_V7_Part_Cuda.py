...
out = cv2.VideoWriter("/home/jetson/yolo/OpenCV/OpenCV_Out_V7_Part_cuda.avi", fourcc, fps, (resize_width, resize_height), True)
...
while True:
    ...
    if ret is True:
        ...
        final_processed_frame = gpu_blurred.download()
        times["gaussian_blur"] += time.time() - start_time

        # Apply background subtraction
        start_time = time.time()
        mog.setHistory(1000)
        mog.setDist2Threshold(3000)
        mask = mog.apply(final_processed_frame)
